...
def main():
    ...
    n_estimators = 100
<<<<<<< HEAD
    learning_rate=0.05 # normalization: scale features using StandardScaler
=======
    learning_rate=0.05 # feature scaling: apply MinMaxScaler instead of standardization
>>>>>>> feature-tuning-23L-2537
